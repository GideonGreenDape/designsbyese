...
function Brandfeature() {
  return (
    <div className="flex flex-row gap-[11px] justify-start items-start">
      ...
      <p className="w-[186px] h-[43px] font-FuturastdBook font-light text-[11px] text-pink">
  ...
  function GiftcardForm() {
   return(
    <div className="flex flxe-row gap-[2px]">
     <p className="w-[73px] h-[13px] self-start font-FuturastdBook font-medium text-[11px] text-pink">Enter Code:</p>
  ...
  function PaymentMethods() {
    return(
        <div className="flex flex-col justify-center h-[58px] w-[124px] gap-[2px]">
         <p className="ml-[15px] w-[138px] h-[13px] font-FuturastdBook font-light text-[11px] text-pink">All Payment Methods</p>
