...
function CustomMade() {
  ...
  return (
    <>
      <Header />
      {menuState? <MenuCard />:<></> }
      <section className="mt-[70px] mb-[400px] min-500:mt-[110px]  flex flex-col gap-[50px] ml-[5%]">
        <p className="font-montserrat font-semibold text-gray text-[19px] w-[270px] min-400:w-[320px]  min-500:text-[17px] min-500:w-[450px] min-1000:w-[400px] ">
